...
export const metadata = {
  title: 'Storefront Glass Repair & Installation | FastFix',
  description: 'Professional storefront glass repair and installation services across the DMV region. Available 24/7.',
}
  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative h-[400px] w-full overflow-hidden">
        <Image
          src="/images/services/storefront-glass.jpg"
          alt="Professional storefront glass installation"
          fill
          ...
          <div className="max-w-6xl mx-auto px-4 w-full">
            <div className="max-w-2xl">
              <h1 className="text-5xl font-bold mb-4 text-white">
                Storefront Glass Repair & Installation
              </h1>
              <p className="text-lg text-white/90 mb-6 max-w-xl">
                Professional storefront glass solutions for your business. Fast, reliable service across the DMV area.
              </p>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          {/* Main Content */}
          <div>
            <h2 className="text-4xl font-bold mb-8 text-[#000000]">Expert Storefront Solutions</h2>
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              FastFix specializes in all types of storefront glass repairs and installations. From custom designs 
              to emergency repairs, our certified technicians ensure your business looks professional and secure.
            </p>
          ...
          <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl group">
            <Image
              src="/images/services/storefront-main.jpg"
              alt="Professional storefront glass service"
              fill
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8">
              <p className="text-xl text-white/90">
                Professional installations by certified technicians
              </p>
            </div>
          </div>
        </div>
