...
export const metadata = {
  title: 'Automatic Door Repair & Installation | FastFix',
  description: 'Professional automatic door repair and installation services across the DMV region. Available 24/7.',
}
  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative h-[400px] w-full overflow-hidden">
        <Image
          src="/images/services/automatic-doors.jpg"
          alt="Professional automatic door installation"
          fill
          ...
          <div className="max-w-6xl mx-auto px-4 w-full">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-white/90 mb-6 max-w-xl">
                Expert automatic door solutions for your business. Fast, reliable service across the DMV area.
              </p>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          {/* Main Content */}
          <div>
            <h2 className="text-4xl font-bold mb-8 text-[#000000]">Expert Automatic Door Solutions</h2>
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              FastFix specializes in all types of automatic door repairs and installations. From sensor repairs 
              to complete system replacements, our certified technicians ensure your doors operate smoothly and safely.
            </p>
          ...
          <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl group">
            <Image
              src="/images/services/automatic-doors-main.jpg"
              alt="Professional automatic door service"
              fill
