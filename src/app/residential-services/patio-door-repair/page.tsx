...
export const metadata = {
  title: 'Patio Door Repair & Installation | FastFix',
  description: 'Expert patio door repair and installation services across the DMV region. Available 24/7.',
}
...
export default function PatioDoorRepair() {
  return (
    <div className="bg-white">
          ...
          <div className="max-w-6xl mx-auto px-4 w-full">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-white/90 mb-6 max-w-xl">
                Expert patio door solutions for your home. Fast, reliable service across the DMV area.
              </p>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          {/* Main Content */}
          <div>
            <h2 className="text-4xl font-bold mb-8 text-[#000000]">Expert Patio Door Solutions</h2>
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              FastFix specializes in all types of patio door repairs and installations. From sliding doors 
              to French doors, our certified technicians ensure smooth operation and security.
            </p>
