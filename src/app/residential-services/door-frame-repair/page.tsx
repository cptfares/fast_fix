...
export const metadata = {
  title: 'Door Frame Repair & Installation | FastFix',
  description: 'Expert door frame repair and installation services across the DMV region. Available 24/7.',
}
...
export default function DoorFrameRepair() {
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <div className="relative h-[400px] w-full overflow-hidden">
        <Image
          src="/images/services/door-frame-repair.jpg"
          ...
          <div className="max-w-6xl mx-auto px-4 w-full">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-white/90 mb-6 max-w-xl">
                Expert door frame solutions for your home or business. Fast, reliable service across the DMV area.
              </p>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          {/* Main Content */}
          <div>
            <h2 className="text-4xl font-bold mb-8 text-[#000000]">Expert Frame Solutions</h2>
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              FastFix specializes in all types of door frame repairs and installations. From damaged jambs 
              to threshold replacements, our certified technicians ensure proper alignment and security.
            </p>
          ...
          <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl group">
            <Image
              src="/images/services/door-frame-main.jpg"
