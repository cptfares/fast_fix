...
export const metadata = {
  title: 'Shower Door Repair & Installation | FastFix',
  description: 'Expert shower door repair and installation services across the DMV region. Available 24/7.',
}
  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative h-[400px] w-full overflow-hidden">
        <Image
          src="/images/services/shower-door-repair.jpg"
          ...
          <div className="max-w-6xl mx-auto px-4 w-full">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-white/90 mb-6 max-w-xl">
                Expert shower door solutions for your bathroom. Professional service across the DMV area.
              </p>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          {/* Main Content */}
          <div>
            <h2 className="text-4xl font-bold mb-8 text-[#000000]">Expert Shower Solutions</h2>
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              FastFix specializes in all types of shower door repairs and installations. From frameless 
              designs to sliding doors, our certified technicians ensure perfect functionality and style.
            </p>
          ...
          <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl group">
            <Image
              src="/images/services/shower-door-main.jpg"
