...
export const metadata = {
  title: 'Glass Repair & Replacement | FastFix',
  description: 'Expert glass repair and replacement services across the DMV region. Call now for a free estimate!',
}
...
const features = [
  ...
  'Custom Aluminum Framing',
  'Emergency Glass Repair',
  '24/7 Service Available'
]

export default function StorefrontInstallation() {
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <div className="relative h-[400px] w-full overflow-hidden">
        <Image
          src="/images/services/storefront-installation.jpg"
          alt="Luxury storefront installation"
          fill
          ...
          <div className="max-w-6xl mx-auto px-4 w-full">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-white/90 mb-6 max-w-xl">
                Professional glass solutions for your business. Available 24/7 across the DMV region.
              </p>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          {/* Main Content */}
          <div>
            <h2 className="text-4xl font-bold mb-8 text-[#000000]">Expert Glass Solutions</h2>
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              FastFix delivers professional glass installation and repair services across Virginia, 
              Washington DC, and Maryland. Our expert team ensures perfect fitting and maximum security 
