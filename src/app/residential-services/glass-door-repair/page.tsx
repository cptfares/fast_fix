...
export const metadata = {
  title: 'Glass Door Repair & Installation | FastFix',
  description: 'Professional glass door repair and installation services across the DMV region. Available 24/7.',
}
...
export default function GlassDoorRepair() {
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <div className="relative h-[400px] w-full overflow-hidden">
        <Image
          src="/images/services/glass-door-repair.jpg"
          alt="Professional glass door repair"
          fill
          ...
          <div className="max-w-6xl mx-auto px-4 w-full">
            <div className="max-w-2xl">
              <h1 className="text-5xl font-bold mb-4 text-white">
                Glass Door Repair & Installation
              </h1>
              <p className="text-lg text-white/90 mb-6 max-w-xl">
                Expert glass door solutions for your home or business. Fast, reliable service across the DMV area.
              </p>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              FastFix specializes in repairing and installing all types of glass doors. From emergency repairs 
              to new installations, our certified technicians deliver quality solutions that last.
            </p>
          ...
          <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl group">
            <Image
              src="/images/services/glass-door-main.jpg"
              alt="Professional glass door repair service"
              fill
